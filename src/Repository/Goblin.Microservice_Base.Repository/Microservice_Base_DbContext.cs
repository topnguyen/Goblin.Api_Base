...
namespace Goblin.Microservice_Base.Repository
{
    ...
    public sealed partial class Microservice_Base_DbContext : Elect.Data.EF.Services.DbContext.DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer(connectionString, sqlServerOptionsAction =>
            {
                ...
                sqlServerOptionsAction.MigrationsAssembly(typeof(Microservice_Base_DbContext).GetTypeInfo().Assembly.GetName().Name);
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.AddConfigFromAssembly<Microservice_Base_DbContext>(typeof(Microservice_Base_DbContext).GetTypeInfo().Assembly);
